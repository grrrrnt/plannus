const colors = ["#E59CA0", "#E1B298", "#DAD6A1", "#A6CFA1", "#8BB9D4", "#AE9CD6"]

export default function formatTimetable(timetable) {
    const timings = []
    const classes = {}
    getTimings(timetable, timings)
    const moduleColors = assignModuleColor(timetable)
...
const getTimings = (timetable, timings) => {
...
const formatClassDetails = (timetable, timings, moduleColors, classes) => {
...
const fillInEmptySlots = (timings, classes) => {
